...
-- ----------------------------------------------------------------------------------------
-- CTB00001- GIS_TB02S007_IDADES2_SETOR
--
-- Criar esta tabela com as colunas:
--
-- codigo          numeric  (2, 0) Not Null PK CL  Código da Pessoa
-- setor           varchar  (45)       Null        Setor de Trabalho
--
-- Atenção:
-- Declarar a Chave Primária (Primary Key, ou Identificador Único, ou apenas PK) através de
-- um constraint de nome PK_GIS_TB02S007_IDADES2_SETOR.
--
...
--
-- Definir um constraint de nome CK_GIS_TB02S007_IDADES2_SETOR_codigo para a coluna codigo,
-- a qual deve admitir valores maiores do que 0 (zero).
--
-- Definir um constraint de nome FK_GIS_TB02S007_IDADES2_SETOR_codigo para a coluna codigo,
...
If  exists 
 (Select *
   ...
   Where object_id  =  OBJECT_ID(N'dbo.CK_GIS_TB02S007_IDADES2_SETOR') 
     and parent_object_id = OBJECT_ID(N'dbo.GIS_TB02S007_IDADES2_SETOR'))
   ALTER TABLE  dbo.GIS_TB02S007_IDADES2_SETOR
      DROP CONSTRAINT CK_GIS_TB02S007_IDADES2_SETOR;
IF  EXISTS
  (select *
    From  sys.objects
    Where object_id = OBJECT_ID(N'dbo.GIS_TB02S007_IDADES2_SETOR') 
      and type in (N'U'))
   DROP TABLE dbo.GIS_TB02S007_IDADES2_SETOR;
--
-- ----------------------------------------------------------------------------------------
-- Criação da tabela.
-- ----------------------------------------------------------------------------------------
--
CREATE TABLE dbo.GIS_TB02S007_IDADES2_SETOR (
  codigo          numeric  (2, 0) Not Null ,
  setor           varchar  (45)       Null ,
  CONSTRAINT PK_GIS_TB02S007_IDADES2_SETOR PRIMARY KEY CLUSTERED 
   (codigo  asc)
   WITH
    FILLFACTOR = 10,
  CONSTRAINT CK_GIS_TB02S007_IDADES2_SETOR_codigo CHECK (codigo > 0),
  CONSTRAINT FK_GIS_TB02S007_IDADES2_SETOR_codigo FOREIGN KEY (codigo)
