...
-- ----------------------------------------------------------------------------------------
-- QUERY047- GIS_TB01S005_CONTINENTE
--
-- Quais são  os continentes cujo nome  não possui as letras  "N" ou "C"  em alguma posição
-- (nesta sequência ou na sequência inversa)?
--
-- ----------------------------------------------------------------------------------------
...
Select codigo        'Código do continente',
  ...
  Where nome not like '%n%c%'
    and nome not like '%c%n%'
    and nome not like 'N%c%   -- Estes 2 predicados foram colocados porque o Like faz
    and nome not like 'C%n%   -- diferenciação entre maiúsculas e minúsculas.
;
--
-- ----------------------------------------------------------------------------------------
-- Comentários.
