    ...
    (Select avg(ext_km2) 'Área média dos países da América'   -- Subselect 1o. nível
       ...
       Where cod_continente IN                             -- Predicado de lista
         (Select codigo                                -- Subselect 2o. nível
            ...
            Where nome = 'América'));            -- Predicado de igualdade
--
-- ----------------------------------------------------------------------------------------
-- Comentários.
-- ----------------------------------------------------------------------------------------
...
--
-- Nesta solução, o SUBSELECT de segundo nível utiliza o predicado de igualdade.
--
-- Este SUBSELECT é executado em primeiro lugar.
--
-- Nesta solução, o SUBSELECT de primeiro nível utiliza o predicado de lista.
--
-- Este SUBSELECT é executado em segundo lugar.
--
-- Na execução deste comando, este SUBSELECT (de primeiro nível) não apresenta erro, porque
-- o predicado de lista aceita vários valores para comparação.
--
-- ----------------------------------------------------------------------------------------
